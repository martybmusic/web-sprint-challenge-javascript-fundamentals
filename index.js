...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array) {
    let lowerNames = array.map(x => x["animal_name"].toLowerCase())
    return lowerNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array) {
    let newArray = array.filter(x=> x["population"] < 5)
    return newArray;
  }
...
lowPopulationAnimals(zooAnimals);
  ...
  */
  ...
  function USApop(array) {
    let total = array.reduce((accum, item) => accum + item["population"],0)
    return total
  }
